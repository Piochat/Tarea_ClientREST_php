...
class DibujantesVo
{
    private $service = 'http://localhost:8989/PumpkinPiesServer/webresources/dibujante/';
    ...
    public function modDibujante($data) 
    {
        $url = $this->service;
    ...
    public function createDibujante($data)
    {
        $url = $this->service;
        $data_json = json_encode($data);
    ...
    public function deleteDibujante($data)
    {
        $url = $this->service;
        $data_json = json_encode($data);
