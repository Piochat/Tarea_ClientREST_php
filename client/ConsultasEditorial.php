...
class Comicsvo 
{
    ...
    private $service = 'http://localhost:8989/PumpkinPiesServer/webresources/editorial/';
    ...
    public function modEditorial($data) 
    {
        $url = $this->service;
    ...
    public function createEditorial($data)
    {
        $url = $this->service;
        $data_json = json_encode($data);
    ...
    public function deleteEditorial($data)
    {
        $url = $this->service;
        $data_json = json_encode($data);
